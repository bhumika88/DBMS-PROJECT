...
<html>
<head>
<title>Add New Record in TRAVELKHANA Database</title>
...
if(isset($_POST['add']))
{
	...
	{
		?>
		<script>alert("Station Already Exists!!Add another field"); window.open("addfield.php","_self");</script>
		<?php	
	}
	else
	{
		...
		$query1=$collection->insert( $record );
		if($query1)
		{
			?>
...
<div id = "header">
  ...
  <span class = "slash">|<img src = "images/login.png" width = "20px" height = "20px" hspace = "7px"> <?php echo "Welcome  ".$admin; ?></span>
	...
	<div id = "mid">
	<span id = "heading">Add Fields<br><br>
	</span>
...
<td>
<input name="station" type="text" id="station" class = "inputsmall" placeholder = "*station name" REQUIRED/>
</td>
</tr>
<tr>
<td width="250" id = "keyword">CUISINE : </td>
<td>
<input name="cuisine" type="text" id="cuisine" placeholder = "*Cuisines" class = "inputsmall" REQUIRED/>
</td>
</tr>
<tr>
<td width="250" id = "keyword">MENU : </td>
<td>
<input name="menu" type="text" id="menu" class = "inputsmall" placeholder = "*Menu" REQUIRED/>
</td>
</tr>
