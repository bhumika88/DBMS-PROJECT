...
<html>
  <head>
    ...
    function drawChart() {
      ...
      var data = new google.visualization.arrayToDataTable([["Cuisine", "Prefernce"], <?php
	...
	//alert(data);
      ...
      var chart = new google.visualization.ColumnChart(document.getElementById('chart_div'));
		var options = {
	    title: 'PREFFERED CUISINES',
	    vAxis: {title: 'Preference', titleTextStyle: {color: 'red'}},
	    hAxis: {title: 'Cuisines', titleTextStyle: {color: 'red'}},
	  };
